...
class TestConnector(IsolatedAsyncioTestCase):
    ...
    async def test_get_files_empty_url(self, mock_file_to_index):
        mock_file_to_index.return_value = None
        result = await self.instance.get_files()
        assert result == []

    @mock.patch("se_api.services.connector.Connector._get_files_from_url")
    @mock.patch("se_api.services.connector.Connector._files_to_index")
    async def test_get_files_none(self, mock_file_to_index, mock_get_file_from_url):
    ...
    @mock.patch("se_api.services.connector.Connector._get_files_from_url")
    @mock.patch("se_api.services.connector.Connector._files_to_index")
    async def test_get_files_list(self, mock_file_to_index, mock_get_file_from_url):
        mock_file_to_index.return_value = ""
    ...
    @mock.patch("se_api.services.connector.Connector._get_files_from_url")
    @mock.patch("se_api.services.connector.Connector._files_to_index")
    async def test_get_files_valid(self, mock_file_to_index, mock_get_files_from_url):
        mock_file_to_index.return_value = ""
    ...
    @mock.patch("se_api.services.connector.Connector._get_files_from_url")
    @mock.patch("se_api.services.connector.Connector._files_to_index")
    async def test_get_files_data(self, mock_file_to_index, mock_get_files_from_url):
        mock_file_to_index.return_value = ""
    ...
    @mock.patch("se_api.services.connector.Connector._get_files_from_url")
    @mock.patch("se_api.services.connector.Connector._files_to_index")
    async def test_get_files_subdata(self, mock_file_to_index, mock_get_files_from_url):
        mock_file_to_index.return_value = ""
